const enUS = {
  ...
  sightReading: {
    ...
    fretRangeHint: '{{count}} natural notes in current range',
    playSound: 'Play Sound',
    playSoundDesc: 'When off, the question note will not auto-play',
    playFeedback: 'Answer Feedback Sound',
    playFeedbackDesc: 'Play an ascending scale as feedback when correct or skipped; turn off to silently advance to the next question',
    howToUse: 'How to Use',
    ...
    keySignatureDesc: 'Select a key signature to restrict the question pool to its major scale. Both the staff and the detected note use that key\'s spelling (e.g. Bb instead of A# in F major).',
