const enUS = {
  ...
  staffNotation: {
    ...
    drillHint: 'Progress through C4, C5, C4+C5, C1, C2, and cross-clef C3 reading drills',
    ...
    stageBassC1: 'Bass · C1 Drill',
    stageBassC1Desc: 'Practice the C1 to B1 low register',
    stageBassC2: 'Bass · C2 Drill',
    stageBassC2Desc: 'Practice the C2 to B2 low register',
    stageCombinedC3: 'Grand Staff · C3 Drill',
    stageCombinedC3Desc: 'Read C3 to B3 across both bass and treble clefs',
